//$Id: SQLLoaderTest.java,v 1.11 2005/01/29 21:30:14 oneovthafew Exp $
...
public class SQLLoaderTest extends TestCase {
	...
	public void testEscapedJDBC() throws HibernateException, SQLException {
		if ( getDialect() instanceof MySQLDialect || getDialect() instanceof PostgreSQLDialect ) return;
	...
	private void componentTest(String sql) throws SQLException, HibernateException {
        Session session = openSession();
