//$Id: FooBarTest.java,v 1.9 2005/01/29 21:54:12 oneovthafew Exp $
...
public class FooBarTest extends TestCase {
	...
	public void testCollectionOfSelf() throws Exception {
		...
		if (getDialect() instanceof HSQLDialect) return; //cos of self-reference
	...
	public void testScrollableIterator() throws Exception {
		if ( getDialect() instanceof DB2Dialect || getDialect() instanceof OracleDialect || getDialect() instanceof SybaseDialect || getDialect() instanceof HSQLDialect ) {
			...
			s = openSession();
			query = s.createQuery("select f, f.integer from f in class Foo");
			assertTrue( query.getReturnTypes().length==2 );
			iter = query.scroll();
			assertTrue( iter.next() );
			assertTrue( iter.scroll(1) );
	...
	public void testService() throws Exception {
		...
		hs.setShowSql(true);
		hs.setMaximumFetchDepth( new Integer(0) );
		hs.start();
		hs.stop();
