//$Id: EntityType.java,v 1.15 2005/01/29 23:01:54 oneovthafew Exp $
...
public abstract class EntityType extends AbstractType implements AssociationType {
	...
	throws HibernateException {
		...
		Object copied = copiedAlready.get(original);
		...
		id = getIdentifierOrUniqueKeyType( session.getFactory() ).copy(id, null, session, owner, copiedAlready);
