//$Id: DynamicComponentType.java,v 1.7 2005/01/29 23:01:54 oneovthafew Exp $
...
public class DynamicComponentType extends AbstractType implements AbstractComponentType {
	...
	public Object copy(Object original, Object target, SessionImplementor session, Object owner, Map copiedAlready) throws HibernateException {
		...
		Object[] values = TypeFactory.copy(
			getPropertyValues(original), getPropertyValues(target), propertyTypes, session, owner, copiedAlready
		);
