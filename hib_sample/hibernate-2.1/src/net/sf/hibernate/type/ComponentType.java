//$Id: ComponentType.java,v 1.26 2005/01/29 23:01:53 oneovthafew Exp $
...
public class ComponentType extends AbstractType implements AbstractComponentType {
	...
	public Object copy(Object original, Object target, SessionImplementor session, Object owner, Map copiedAlready) throws HibernateException {
		...
		Object[] values = TypeFactory.copy(
			getPropertyValues(original), getPropertyValues(result), propertyTypes, session, owner, copiedAlready
		);
